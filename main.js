...
function ajaxFilm(search) {
  $.ajax({
    url: "https://api.themoviedb.org/3/search/movie?api_key=2949182a20ec9f3c52a5bedc673809f5&query=" + search,
    method: "GET",
...
function ajaxSerie(search) {
  $.ajax({
    url: "https://api.themoviedb.org/3/search/tv?api_key=2949182a20ec9f3c52a5bedc673809f5&query=" + search,
    method: "GET",
    success: function(data) {
      var results = data.results;
      for (var i = 0; i < results.length; i++) {
...
function castactfilm(datifilm) {
  var actor = "";
  $.ajax({
    url: "https://api.themoviedb.org/3/movie/" + datifilm.id + "/credits?api_key=2949182a20ec9f3c52a5bedc673809f5",
    method: "GET",
    success: function(data) {
      var cast = data.cast;
...
function castactserie(datiserie) {
  var actor = "";
  $.ajax({
    url: "https://api.themoviedb.org/3/tv/" + datiserie.id + "/credits?api_key=2949182a20ec9f3c52a5bedc673809f5",
    method: "GET",
    success: function(data) {
      var cast = data.cast;
      for (var i = 0; i < 5 && i < cast.length; i++) {
